...
| AV_SCAN_MAX_FILE_SIZE_BYTES | The maximum size, in bytes, of a file that will be scanned. Files larger than this size will be tagged with `AV_STATUS_SKIPPED`.  Currently does not support values above 25000000 | 25000000 | No |
...
| AV_STATUS_SNS_ARN | SNS topic ARN to publish scan results of INFECTED files. (optional) | | No |
